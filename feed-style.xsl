  ...
  <xsl:template match="/">
    ...
    <body>
        <div style="vertical-align: top; text-align: left;">
            <a href="https://trevorion.io"><img src="/assets/Anime%20AIS.jpg" alt="Trevorion Avatar" style="width: 100px; height: 100px; float: left; margin-top: 24px; margin-right:10px;" /></a>
